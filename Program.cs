...
do //faça{
{
    ...
    for (int i = 0; i < 25; i++)
    {
        ...
        Console.Write(new string(' ', 80));//plano de fundo
    }
    ...
    opc = Convert.ToInt16(ReadLine());//Leia(opc)
...
static void janela(int C1, int L1, int C2, int L2, char borda, ConsoleColor corF, ConsoleColor corB)
{
    ...
    ConsoleColor corFOirginal = Console.ForegroundColor;
